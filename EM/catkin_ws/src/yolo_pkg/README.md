...
```
Camera Node                   FallDetectionNode                           EnhancedFallDetector
    |                                 |                                              |
    |---- 이미지 게시 /camera/image_raw --->|                                              |
    |                                 |                                              |
    |                                 | 1. image_callback 호출                       |
    |                                 |--------------------------------------------->|
    |                                 |               이미지 수신 및 cv2 변환          |
    |                                 |<---------------------------------------------|
    |                                 |                                              |
    |                                 | 2. asyncio.run(self.detector.process_frame)   |
    |                                 |--------------------------------------------->|
    |                                 |                                              |  
    |                                 |                   비동기 프레임 처리          |
    |                                 |<---------------------------------------------|
    |                                 |                                              |
    |                                 | 3. cv2_to_imgmsg 및 결과 이미지 퍼블리시        |
    |                                 |--------------------------------------------->|----> /fall_detection/output
    |                                 |                                              |
    |                                 | 4. 만약 fall_detected True, 로그 출력           |
    |                                 |--------------------------------------------->|
    ```